...
class ErrorResponses:
    ...
    @classmethod
    def NotFound(cls, raise_error: bool = False, message: str = "item", replace_message: bool = False) -> dict:
    ...
    @classmethod
    def Unauthorized(cls, raise_error: bool = False) -> dict:
        response_model = ErrorResponseModel(
    ...
    """ 
    @classmethod
    def ItemExists(cls, raise_error: bool = False, message: str = "Item") -> dict:
        response_model = ErrorResponseModel(
    ...
    @classmethod
    def Conflict(cls, raise_error: bool = False, message: str = "", description: str = "") -> dict:
        response_model = ErrorResponseModel(
            code=status.HTTP_409_CONFLICT,
    ...
    @classmethod
    def ValueError(cls, raise_error: bool = False, message: str = "", description: str = "") -> dict:
        response_model = ErrorResponseModel(
    ...
    @classmethod
    def BadRequest(cls, raise_error: bool = False, message: str = "", description: str = "") -> dict:
        response_model = ErrorResponseModel(
            code=status.HTTP_400_BAD_REQUEST,
            description=description or "BadRequest",
            message=message or "Request"
        )
        return cls.__error_response(response_model, raise_error)

    @classmethod
    def __error_response(cls, response_model: ErrorResponseModel, raise_error: bool = False):
        if raise_error:
